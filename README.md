...
originally coded by: https://github.com/denandz
...
```bash
go install github.com/cyphernova1337/sourcemapper@latest
```

Otherwise you can clone and build:

```bash
git clone https://github.com/cyphernova1337/sourcemapper
cd sourcemapper
go get
go build
```
